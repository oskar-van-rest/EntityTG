...
public class EntityTGParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("EntityTG");
  ...
  { 
    EntityTGParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = EntityTGParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = EntityTGParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(EntityTGParseControllerGenerated.class);
    }
  ...
  { 
    return EntityTGParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
